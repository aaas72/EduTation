...
<body>
    <nav class="navbar">
        <div class="container-navbar">
            <div class="nav-row">
                ...
                <ul class="buttons">
                    <li><a class="login-but" href="Login_Signup/loginpage.php"><button class="text">Oturum Aç</button></a></li>
                    <li><a class="signup-but" href="Login_Signup/signuppage.php"><button class="text">Kaydol</button></a></li>
                </ul>
            </div>
    ...
    <div class="available">
            <div class="container-available">
                ...
                <div class="boxs">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<div class="info">';
                            echo '<div class="join">';
                            echo '<a class="href" href="Login_Signup/loginpage.php"><p class="text">ŞİMDE KATIL</p></a>';
                            echo '</div>';
                            echo '</div>';
                            echo '</div>';
                        }
                ...
                <button ><a href="Login_Signup/loginpage.php">Daha fazla gör</a></button>
            </div>
        </div>
    <div class="paths">
    ...
    <div class="recent">
        <div class="container-recent">
            ...
            <a href="Login_Signup/loginpage.php">Daha fazla gör</a>
        </div>
    </div>
    <div class="events">
